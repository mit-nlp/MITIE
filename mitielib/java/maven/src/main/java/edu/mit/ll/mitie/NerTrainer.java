...
public class NerTrainer {
  ...
  public NerTrainer(String filename) {
    this(globalJNI.new_NerTrainer__SWIG_0(filename), true);
  }

  public NerTrainer(TotalWordFeatureExtractor extractorObject) {
    this(globalJNI.new_NerTrainer__SWIG_1(TotalWordFeatureExtractor.getCPtr(extractorObject), extractorObject), true);
  }
