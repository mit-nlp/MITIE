...
SWIGEXPORT jlong JNICALL Java_edu_mit_ll_mitie_globalJNI_new_1MicroNER(JNIEnv *jenv, jclass jcls, jstring jarg1) {
  jlong jresult = 0 ;
  std::string *arg1 = 0 ;
  MicroNER *result = 0 ;
  ...
  {
    try {
      result = (MicroNER *)new MicroNER((std::string const &)*arg1);
    } catch(std::exception& e) {
      jclass clazz = jenv->FindClass("java/lang/Exception");
      jenv->ThrowNew(clazz, e.what());
      return 0;
  ...
  *(MicroNER **)&jresult = result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroNER_1getPossibleNerTags(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  MicroNER *arg1 = (MicroNER *) 0 ;
  std::vector< std::string > result;
  ...
  {
    try {
      result = ((MicroNER const *)arg1)->getPossibleNerTags();
    } catch(std::exception& e) {
      jclass clazz = jenv->FindClass("java/lang/Exception");
      jenv->ThrowNew(clazz, e.what());
      return 0;
...
SWIGEXPORT jlong JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroNER_1extractEntities_1_1SWIG_10(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_, jlong jarg3, jobject jarg3_) {
  jlong jresult = 0 ;
  MicroNER *arg1 = (MicroNER *) 0 ;
  ...
  {
    try {
      result = ((MicroNER const *)arg1)->extractEntities((TotalWordFeatureExtractor const &)*arg2,(std::vector< std::string > const &)*arg3);
    } catch(std::exception& e) {
      jclass clazz = jenv->FindClass("java/lang/Exception");
      jenv->ThrowNew(clazz, e.what());
      return 0;
...
SWIGEXPORT jlong JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroNER_1extractEntities_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_, jlong jarg3, jobject jarg3_) {
  jlong jresult = 0 ;
  MicroNER *arg1 = (MicroNER *) 0 ;
  TotalWordFeatureExtractor *arg2 = 0 ;
  std::vector< TokenIndexPair > *arg3 = 0 ;
  std::vector< EntityMention > result;
  ...
  arg3 = *(std::vector< TokenIndexPair > **)&jarg3;
  if (!arg3) {
  ...
  {
    try {
      result = ((MicroNER const *)arg1)->extractEntities((TotalWordFeatureExtractor const &)*arg2,(std::vector< TokenIndexPair > const &)*arg3);
    } catch(std::exception& e) {
      jclass clazz = jenv->FindClass("java/lang/Exception");
      jenv->ThrowNew(clazz, e.what());
      return 0;
...
SWIGEXPORT void JNICALL Java_edu_mit_ll_mitie_globalJNI_delete_1MicroNER(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  MicroNER *arg1 = (MicroNER *) 0 ;
