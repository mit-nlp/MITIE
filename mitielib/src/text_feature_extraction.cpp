...
//            result.push_back(make_feat(shash(words[i],1000)));
        ...
        matrix<float,0,1> first = all_sum; //feats[chunk_range.first];ll;
        matrix<float,0,1> last = all_sum; //feats[chunk_range.second-1];
        matrix<float,0,1> before = all_sum;
        matrix<float,0,1> after = all_sum;
